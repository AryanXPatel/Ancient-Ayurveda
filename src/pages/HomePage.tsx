  ...
  return (
    <PageTransition>
      <div className="min-h-screen">
        ...
        <section className="bg-gradient-to-r from-green-50 to-yellow-50 py-20">
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center">
              <h1 className="text-4xl md:text-6xl font-bold text-gray-900 mb-4 leading-tight animate-fadeInDown">
              ...
              <p className="text-lg text-gray-600 max-w-3xl mx-auto mb-6 leading-relaxed animate-fadeInUp">
                Experience traditional wellness with Dr. Niyati Patel, a
        ...
        {/* Final CTA Section - Updated with Green Gradient */}
        <section className="py-20 bg-gradient-to-r from-green-600 to-emerald-600 text-white">
          <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            <h2 className="text-3xl font-bold mb-4 text-white animate-fadeInDown">
              Ready to Begin Your Wellness Journey?
            </h2>
            <p
              className="text-xl mb-8 text-green-50 animate-fadeIn"
